...
BASE_DIR_PROJECT = os.path.abspath(os.path.dirname(os.path.dirname(__file__)))
INSTANCE_FOLDER_PATH = os.path.join(BASE_DIR_PROJECT, 'instance')
DEFAULT_DATABASE_FILE = "tvde_bookings.db"
SQLALCHEMY_DATABASE_URI = f"sqlite:///{os.path.join(INSTANCE_FOLDER_PATH, DEFAULT_DATABASE_FILE)}"
